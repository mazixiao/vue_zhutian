...
export default {
  ...
  data () {
    return {
        ...
        fresh: {
          title: '新鲜材料',
          introduct: '从田野到餐桌，实现麻辣烫的“品质健康”新升级。每一种食材，都足够新鲜，每一种味道，都用心调制。搭配酥肉、糍粑等小吃及特制饮品及樱花冰粉，新鲜制作，打造轻食健康麻辣烫。',
          fresh_img: [fresh1, fresh2, fresh3, fresh4]
        },
        craft: {
          title: '优质工艺',
          introduct: '传统麻辣烫行业采取的是一锅炖重复煮，既不卫生菜品还容易串味，煮田采用一人一锅煮的方式，现选现煮保证了每一碗出品的原汁原味。',
